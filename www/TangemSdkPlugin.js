...
var TangemSdk = {
	 ...
	 * @property {Data} publicKey aullet public key
	 */
	...
	/**
	 * @typedef {Object} scanCardResponse Response for `ReadCommand`. Contains detailed card information
	 * @property {string} [cardId] Unique Tangem card ID number.
	 ...
	 * @property {boolean} [isPin1Default] Set by ScanTask
	 * @property {boolean} [isPin2Default] Set by ScanTask
	 * @property {boolean} [pin2IsDefault] Available only for cards with COS v.4.0 and higher.
	 * @property {number} [walletIndex] Index of corresponding wallet
	 ...
	 * @param {scanCardResponse} [response]
	 * @param {TangemSdkError} [error] Error
	 * @return {void}
	 */
	 ...
	 * @property {number} [walletRemainingSignatures] Remaining number of sign operations before the wallet will stop signing transactions.
	 * @property {number} [walletSignedHashes] Total number of signed single hashes returned by the card in sign command responses.
	 */

	/**
	 * The callback for success scan card.
	 * @callback SignCallback
	 * @param {SignResponse} [response] Response for `Sign` Command
	 * @param {TangemSdkError} [error] Error
	 * @return {void}
	 */
	 ...
	 * @param {VerifyResponse} [response] Responce for `Verify` Command
	 * @param {TangemSdkError} [error] Error
	 * @return {void}
	 */
	 ...
	 */
	writeIssuerData: function (userData, userCounter, cardId, initialMessage, callback) {
		exec(
			'writeIssuerData',
			{
				userData: userData,
